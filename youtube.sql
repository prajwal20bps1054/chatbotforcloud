...
(3, 'what is your name||whats your name||who are you', 'My name is prajwal.'),
(4, 'what should I call you', 'You can call me by my name prajwal.'),
(5, 'Where can i apply for viteee', 'vit portal'),
(6, 'Bye||See you later||Have a Good Day||tata', 'Sad to see you are going. Have a nice day'),
(8, 'i want admission in vit', 'please take the viteee exam and then contack us '),
(10, 'I want to ask about professors of first year.', 'Professors of vit are amazing best faculty in the tamil nadu');
